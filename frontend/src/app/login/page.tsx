    ...
    return (
        <div style={{
            ...
            <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', pointerEvents: 'none' }}>
                <div style={{ position: 'absolute', top: '30%', left: '20%', width: 300, height: 300, borderRadius: '50%', background: 'rgba(255,182,6,0.06)', filter: 'blur(100px)' }} />
                <div style={{ position: 'absolute', bottom: '30%', right: '20%', width: 250, height: 250, borderRadius: '50%', background: 'rgba(255,152,0,0.06)', filter: 'blur(100px)' }} />
            </div>
