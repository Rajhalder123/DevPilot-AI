...
// NOTE: This endpoint uses the legacy 5-component formula for backward compatibility.
// For the new 3-component scoring engine, use POST /api/score/full-analysis.
router.get('/', authenticate, asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    // Weighted overall score (legacy formula)
